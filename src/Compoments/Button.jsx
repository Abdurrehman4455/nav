...
const Button = ({label,image}) => {
  return (
   <button className='px-5  py-3  mt-[15%] bg-[#4CAF4F] text-[#FFFFFF] flex ml-10   max-sm:text-center max-sm:text-[13px] max-sm:py-2 rounded-lg  text-center  lg:block md:hiiden' >
