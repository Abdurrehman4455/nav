...
const Nav = () => {
  ...
  return ( 
    ...
    <div className="w-[40%] max-sm:w-[20%] flex items-center font-semibold sm:pl-[10%] max-sm:h-[30px]  max-sm:ml-2 md:ml-0  xl:mt-0 xl:ml-0  ">
      <img 
        src={Logo} 
        alt="logo" 
    ...
    <div className="w-[50%] max-sm:w-[50%] flex max-sm:flex-row max-sm:items-center mt-2  max-sm:overflow-hidden md:justify-end   lg:mr-4 max-sm:justify-end sm:justify-end  lg:mt-0 lg:mr-[10%] xl:mr-[5%] xl:justify-between xl:mt-0">
      <div className="md:block lg:hidden max-sm:block max-md:hidden sm:block  lg:mt-0  max-sm:ml-[13px] sm:justify-end xl:hidden md:ml-10">
