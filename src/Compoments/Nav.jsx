...
const Nav = () => {
  ...
  return ( 
    ...
    <div className="w-[50%] max-sm:w-[50%] flex max-sm:flex-row max-sm:items-center mt-2 sm:mt-0 max-sm:overflow-hidden md:justify-end md:mr-4 pr-11 lg:mr-4 max-sm:justify-end sm:justify-end sm:mt-7 lg:mt-0 lg:mr-[10%] xl:mr-[5%] xl:justify-between xl:mt-0">
      <div className="md:block lg:hidden max-sm:block max-md:hidden sm:block md:mt-10 max-sm:mt-5 max-sm:ml-[13px] sm:justify-end xl:hidden">
      ...
      <div className="flex max-sm:text-[14px] max-sm:text-center max-sm:justify-center md:hidden lg:block sm:hidden max-sm:hidden lg:mr-[1%] xl:block xl:mr-0">
        <Button label="Register Now" image={Right} className="mb-10 sm:mb-0 max-sm:text-[10px] text-center md:hidden lg:pb-10 xl:pb-0 xl:mb-0" />
      </div>
    </div>
  </div>
