...
const Customers = () => {
  return (
    <div className="flex justify-center max-sm:flex-col max-sm:mt-20 md:flex-col md:mt-10 items-center lg:flex-row">
  <div className="w-[30%] max-sm:w-[60%] md:w-[50%] lg:w-[30%]">
    <img src={Image} alt="frame" width={500} />
  </div>
  <div className="w-[40%] max-sm:w-full max-sm:pl-4 max-sm:pr-4 max-sm:pt-2 md:w-[80%] md:pl-4 md:pr-4 md:pt-4 lg:w-[40%]">
    <div className="pb-[14%] md:pb-[10%]">
      <p className="text-[#717171] text-[20px] pb-[4%] max-sm:text-left md:text-center md:text-[18px]">
