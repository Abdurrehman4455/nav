...
const Clients = () => {
  return (
    ...
    <div className=''>
      ...
      <div className='pt-10 flex pl-[10px] w-full justify-around max-sm:flex max-sm:items-center md:pl-0 md:justify-between md:pt-8 md:ml-3'>
        <div className='md:w-[12%]'>
          <img src={Logo1} alt='logo' className='max-sm:ml-2 md:ml-0 md:w-[50%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo2} alt='logo' className='md:w-[55%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo3} alt='logo' className='md:w-[50%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo4} alt='logo' className='md:w-[50%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo5} alt='logo' className='md:w-[50%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo6} alt='logo' className='md:w-[50%]' />
        </div>
        <div className='pl-[15px] md:pl-0 md:w-[12%]'>
          <img src={Logo7} alt='logo' className='md:w-[50%]' />
        </div>
      </div>
    </div>
  </div>
