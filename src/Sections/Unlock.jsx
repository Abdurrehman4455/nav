...
const Unlock = () => {
  ...
  <span className="text-[#4D4D4D] font-semibold text-[30px] ml-2 max-sm:text-[24px] max-sm:ml-0 max-sm:text-left sm:text-[35px] sm:ml-10 sm:text-center md:text-[20px] md:ml-[40%] lg:text-[30px] md:text-center lg:text-left lg:ml-0 ">
    years at Pixelgrade
  </span>
