...
const Hero = () => {
  ...
  return ( 
    ...
    <div className='w-full bg-[#F5F7FA] h-[700px] flex justify-around flex-wrap max-sm:flex-col max-sm:items-center pr-5 ml-[3%] md:justify-around md:h-[700px] lg:justify-around lg:h-[700px] lg:mt-0'>
