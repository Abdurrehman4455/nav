...
const Hero = () => {
  ...
  return ( 
    ...
    <div className="w-full md:w-[40%] lg:w-[30%] pt-[10%] md:pt-[10%] lg:pt-[10%] max-sm:pt-2 max-sm:w-full max-sm:pl-0 max-sm:pr-4  md:justify-center items-center  lg:ml-[6%] md:pl-[10%] lg:pl-0 ">
