  ...
  return (
    ...
    <div className='flex justify-center items-center max-sm:flex-col max-sm:mt-20 sm:flex-col sm:mt-10 md:flex-col md:mt-10 lg:flex-row lg:mt-10'>
      ...
      <div className="w-[40%] pl-[5%] pt-[10%] ml-10 max-sm:w-full max-sm:pl-0 max-sm:pr-4 max-sm:pt-2 sm:w-full sm:pl-0 sm:pr-4 sm:pt-2 md:w-full md:pl-0 md:pr-4 md:pt-2 lg:w-[50%] lg:pl-[2%] lg:pt-[5%] lg:mb-[120px]">
        <h1 className="text-[#4D4D4D] font-bold text-[40px] mt-1 max-sm:text-[24px] max-sm:mt-1 max-sm:text-left sm:text-[30px] sm:text-center md:text-[30px] md:text-center lg:text-[40px] lg:text-left">
          How to design your site footer like
        </h1>
        <span className="text-[#4D4D4D] font-bold text-[40px] mt-1 max-sm:text-[24px] max-sm:ml-0 max-sm:text-left sm:text-[30px] sm:text-center md:text-[30px] md:ml-[40%] md:text-center lg:text-[40px] lg:text-left lg:ml-0 sm:ml-[40%]">
          we did
        </span>
        <p className="text-[#717171] text-[20px] max-sm:ml-0 max-sm:text-[14px] max-sm:text-left sm:text-[18px] sm:text-center md:text-[16px] md:text-center lg:text-[18px] lg:text-left">
