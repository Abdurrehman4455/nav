...
const Calander = () => {
  ...
  <h1 className="text-[#4D4D4D] font-bold text-[40px] max-sm:text-[19px] mt-1 max-sm:mt-1 max-sm:text-left">
    How to design your site footer like
  </h1>
  <span className="text-[#4D4D4D] font-bold text-[40px] max-sm:text-[19px] mt-1 max-sm:ml-0 max-sm:text-left">
    we did
  </span>
  <p className="text-[#717171] text-[20px] max-sm:ml-0 max-sm:text-left">
